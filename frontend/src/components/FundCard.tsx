...
export default function FundCard({ fund, className, style }: Props) {
  ...
  return (
    <article
      className={cn("interactive-card cursor-pointer p-4 flex flex-col gap-3", className)}
      style={style}
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <SparkLine values={fund.nav_sparkline} width={72} height={28} className="shrink-0 mt-0.5" />
      </div>
